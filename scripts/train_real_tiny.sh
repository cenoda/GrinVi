...
echo "════════════════════════════════════════════════════════════"
python scripts/prepare_data.py --dataset ko_wikipedia --out data/ --max_tokens "$MAX_ITEMS"

DATA_FILE="data/ko_wikipedia/train.txt"
VAL_FILE="data/ko_wikipedia/val.txt"
...
echo "  python scripts/generate.py --checkpoint checkpoints/step-final"
echo ""
echo "Example:"
echo "  python scripts/generate.py --checkpoint checkpoints/step-final --prompt '한국은'"
echo ""
